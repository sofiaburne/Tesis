...
d, h, m, day_frac, Bx, By, Bz, X, Y, Z = np.loadtxt(path_mag+'alta_frec/mvn_mag_l2_2014359pc_20141225_v01_r01.sts', skiprows = 147, usecols = (1,2,3,6,7,8,9,11,12,13),unpack = True)
